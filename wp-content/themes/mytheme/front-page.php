...
<section class="almana-about-section">
    <div class="almana-container">
        
        <div class="almana-content">
            <span class="almana-subtitle">About Us</span>
            <h2 class="almana-title">Seven decades of care and quality</h2>
            <p class="almana-description">
                Since our inception in 1949, we have a legacy of excellence. We are a family hospital fully dedicated to caring for the needs of the patients, other partners, and Kingdom we serve to keep healthy. Almana believes in offering compassionate care, inspired by family values which ...
            </p>
            <a href="#" class="almana-btn">
                Read More <span class="almana-arrow">→</span>
            </a>
        </div>

        <div class="almana-visual">
            <div class="almana-card">
                <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800" alt="Almana Hospital">
                
                <div class="almana-play-overlay">
                    <div class="almana-play-circle">
                        <div class="almana-triangle"></div>
                    </div>
                </div>

                <div class="almana-year-box">
                    <span class="almana-year-digit">1949</span>
                    <p class="almana-year-label">Serving the <br> community since</p>
                </div>
            </div>
        </div>
...
<section class="clinic-services">
    ...
    <p class="section-subtitle">
        We provide high-quality healthcare services with professional doctors and modern equipment.
    </p>
    ...
    <div class="services-grid">
        <div class="service-card">
            ...
            <p>Professional diagnosis and medical advice for patients of all ages.</p>
        </div>

        <div class="service-card">
            <i class="fas fa-stethoscope"></i>
            <h3>Primary Care</h3>
            <p>Routine checkups, preventive care, and chronic disease management.</p>
        </div>

        <div class="service-card">
            <i class="fas fa-baby"></i>
            <h3>Pediatric Care</h3>
            <p>Comprehensive healthcare services for infants and children.</p>
        </div>

        <div class="service-card">
            <i class="fas fa-syringe"></i>
            <h3>Vaccination</h3>
            <p>Safe and effective immunization services for all age groups.</p>
        </div>

        <div class="service-card">
            <i class="fas fa-heartbeat"></i>
            <h3>Health Screening</h3>
            <p>Early detection through regular health checkups and tests.</p>
        </div>

        <div class="service-card">
            <i class="fas fa-notes-medical"></i>
            <h3>Laboratory Tests</h3>
            <p>Accurate and reliable lab testing using modern technology.</p>
        </div>
        <div class="service-card">
...
<div class="almana-departments-section">
    <div class="dept-header">
        ...
        <a href="#" class="all-depts-link">ALL DEPARTMENTS <span class="arrow">→</span></a>
    </div>

    <div class="dept-grid">
        <div class="dept-item">
            <img src="https://images.unsplash.com/photo-1551076805-e1869033e561?auto=format&fit=crop&q=80&w=800" alt="Anesthesiology">
            <div class="dept-overlay">
                <div class="dept-info">
                    <img src="https://img.icons8.com/ios/100/2196F3/brain.png" class="dept-icon" alt="icon">
        ...
        <div class="dept-item">
            <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800" alt="Cardiac Surgery">
            <div class="dept-overlay">
                <div class="dept-info">
                    <img src="https://cdn-icons-png.flaticon.com/512/2966/2966327.png" class="dept-icon" alt="icon">
        ...
        <div class="dept-item">
            <img src="https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&q=80&w=800" alt="Cath Lab">
            <div class="dept-overlay">
                <div class="dept-info">
                    <img src="https://img.icons8.com/ios/100/2196F3/hand.png" class="dept-icon" alt="icon">
                    <h3>Cath Lab</h3>
                </div>
            </div>
        </div>
